...
public class State   {
  ...
  @JsonProperty("seenByPeers")
  private Integer seenByPeers = null;
  ...
  public State seenByPeers(Integer seenByPeers) {
    this.seenByPeers = seenByPeers;
    return this;
  }

  /**
   * count of peers that have seen this transaction
   * @return seenByPeers
   **/
  @JsonProperty("seenByPeers")
  @ApiModelProperty(value = "count of peers that have seen this transaction")
  public Integer getSeenByPeers() {
    return seenByPeers;
  }

  public void setSeenByPeers(Integer seenByPeers) {
    this.seenByPeers = seenByPeers;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.state, state.state) &&
        ...
        Objects.equals(this.seenByPeers, state.seenByPeers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(state, depthInBlocks, seenByPeers);
  }
  ...
  public String toString() {
    ...
    sb.append("    seenByPeers: ").append(toIndentedString(seenByPeers)).append("\n");
    sb.append("}");
    return sb.toString();
  }
